...
A Codex plugin that automates initial data analysis for high-dimensional single-cell biology data. Supports CyTOF (mass cytometry), scRNA-seq, and flow cytometry with automatic data type detection and plain-language clinical report generation.
...
git clone https://github.com/<your-username>/bioinformatics-init-analysis.git \
    ~/.Codex/plugins/bioinformatics-init-analysis
```
...
Once installed, trigger the skill in Codex with phrases like:
